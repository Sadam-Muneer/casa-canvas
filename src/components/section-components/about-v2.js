          ...
          <div className="row">
            <div className="col-lg-6 align-self-center">
              <div className="about-us-info-wrap">
                ...
                <ul className="ltn__list-item-2 ltn__list-item-2-before--- ltn__list-item-2-img mb-50">
                  <li>
                    <a
                      href={publicUrl + "/assets/img/homeimages/home4.jpg"}
                  ...
                  <li>
                    <a
                      href={publicUrl + "/assets/img/homeimages/home5.jpg"}
                      data-rel="lightcase:myCollection"
                    >
                      <img
                  ...
                  <li>
                    <a
                      href={publicUrl + "/assets/img/homeimages/home6.jpg"}
                      data-rel="lightcase:myCollection"
                    >
                      <img
                        src={publicUrl + "/assets/img/homeimages/home6.jpg"}
                        alt="Image"
                      />
                    </a>
                  </li>
            ...
            <div className="col-lg-6 align-self-center">
              <div className="about-us-img-wrap about-img-right">
                <img
                  src={publicUrl + "/assets/img/homeimages/home3.png"}
                  alt="About Us Image"
                />
              </div>
            </div>
