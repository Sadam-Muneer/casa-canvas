              ...
              <div className="col-lg-12">
                <div className="ltn__product-item ltn__product-item-4 text-center---">
                  <div className="product-img go-top">
                    <Link to="/blog-grid">
                      <img
                        src={publicUrl + "/assets/img/homeimages/rent.jpg"}
                        alt="#"
                      />
                    </Link>
                  ...
                  <div className="product-info">
                    ...
                    <h2 className="product-title go-top">
                      <Link to="/blog-grid">New Apartment Nice View</Link>
                    </h2>
                    ...
                    <div className="real-estate-agent">
                      <div className="agent-img go-top">
                        <Link to="/team-details">
                          <img
                            src={
                              publicUrl + "/assets/img/homeimages/william.jpg"
                            }
                            alt="#"
                          />
                        </Link>
                      ...
                      <ul>
                        ...
                        <li>
                          <span className="go-top">
                            <Link to="/blog-grid" title="Product Details">
              ...
              <div className="col-lg-12">
                <div className="ltn__product-item ltn__product-item-4 text-center---">
                  <div className="product-img go-top">
                    <Link to="/blog-grid">
                      <img
                        src={publicUrl + "/assets/img/homeimages/modern.jpg"}
                        alt="#"
                      />
                    </Link>
                    <div className="product-badge">
                  ...
                  <div className="product-info">
                    ...
                    <h2 className="product-title go-top">
                      <Link to="/blog-grid">Modern Apartments</Link>
                    </h2>
                    <div className="product-description">
                      <p>
                        Beautiful Huge 1 Family House In Heart Of <br />
              ...
              <div className="col-lg-12">
                <div className="ltn__product-item ltn__product-item-4 text-center---">
                  <div className="product-img go-top">
                    <Link to="/blog-grid">
                      <img
                        src={publicUrl + "/assets/img/homeimages/rent2.jpg"}
                        alt="#"
                      />
                    </Link>
                    <div className="product-badge">
                  ...
                  <div className="product-info">
                    ...
                    <h2 className="product-title go-top">
                      <Link to="/blog-grid">Comfortable Apartment</Link>
                    </h2>
                    <div className="product-description">
                      <p>
                        Beautiful Huge 1 Family House In Heart Of <br />
              ...
              <div className="col-lg-12">
                <div className="ltn__product-item ltn__product-item-4 text-center---">
                  <div className="product-img go-top">
                    <Link to="/blog-grid">
                      <img
                        src={publicUrl + "assets/img/homeimages/luxury.jpg"}
                        alt="#"
                      />
                    </Link>
                    <div className="product-badge">
                  ...
                  <div className="product-info">
                    ...
                    <h2 className="product-title go-top">
                      <Link to="/blog-grid">Luxury villa in Rego Park </Link>
                    </h2>
                    <div className="product-description">
                      <p>
                        Beautiful Huge 1 Family House In Heart Of <br />
              ...
              <div className="col-lg-12">
                <div className="ltn__product-item ltn__product-item-4 text-center---">
                  <div className="product-img go-top">
                    <Link to="/blog-grid">
                      <img
                        src={publicUrl + "assets/img/homeimages/flat.jpg"}
                        alt="#"
                      />
                    </Link>
                    <div className="product-badge">
                  ...
                  <div className="product-info">
                    ...
                    <h2 className="product-title go-top">
                      <Link to="/blog-grid">Beautiful Flat in Manhattan </Link>
                    </h2>
                    <div className="product-description">
                      <p>
                        Beautiful Huge 1 Family House In Heart Of <br />
                      ...
                      <div className="row">
                        <div className="col-12">
                          ...
                          <div className="modal-product-info go-top">
                            <h5>
                              <Link to="/blog-grid">Brake Conversion Kit</Link>
                            </h5>
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-6 col-12">
                          <div className="modal-product-info">
                            ...
                            <div className="modal-product-meta ltn__blog-grid-menu-1">
                              <ul>
                                <li>
                            ...
                            <div className="ltn__blog-grid-menu-2">
                              <ul>
                                <li>
